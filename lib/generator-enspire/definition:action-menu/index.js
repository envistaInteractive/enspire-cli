    ...
    prompting () {
        ...
        return this.prompt([
            ...
            },
            {
                type: 'input',
                name: 'description',
                message: 'Your action menu description',
                default: ''
            }]).then((answers) => {
            ...
            const destinationPath = `lib/definitions/action-menus/${filePath}.json`;

            this.fs.copyTpl(
                this.templatePath('action-menu.json'),
